...
After thorough analysis including the hermiticity concern, we recommend \*\*Starlark (via
starlark-pyo3)\*\*as the single scripting language for Family Assistant.
...
The hermiticity principle is about what Starlark can do directly, not what we choose to expose to
it. Our approach is pragmatic, secure, and aligned with how embedded scripting languages are
