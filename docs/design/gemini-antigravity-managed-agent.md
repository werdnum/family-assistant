...
(`antigravity-preview-09-2026`): a general-purpose agent that plans and executes multi-step tasks —
...
- `coder` → agent `antigravity-preview-09-2026` reasoning with `gemini-3.8-flash`, slash command
  `/coder`.
