...
M2 has landed: manual fixtures for the engineer's threat shapes (hostile content in LLM request
...
| ----------------------------------- | --------- | --------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `spawn_worker`                      | `confirm` | `review`  | The task description is the worker's only inlet from FA and is rendered in full                                                                                                            |
