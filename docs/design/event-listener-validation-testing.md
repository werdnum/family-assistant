...
async def mock_ha_source():
    ...
    zones = ["home", "work", "chatswood", "grocery_store"]
...
class TestHomeAssistantValidation:
    ...
    async def test_nonexistent_entity(self, exec_context_with_validation):
        ...
        result = await create_event_listener_tool(
            ...
            listener_config={
                "match_conditions": {
                    "entity_id": "person.teija",  # Doesn't exist
    ...
    async def test_invalid_person_state(self, exec_context_with_validation):
        ...
        result = await create_event_listener_tool(
            ...
            listener_config={
                "match_conditions": {
                    ...
                    "new_state.state": "Chatswood",  # Wrong case
                }
            },
        )
        ...
        assert "chatswood" in state_error["suggestion"]  # Case correction
...
VALIDATION_TEST_CASES = [
    ...
    ("person.andrew", "home", True, None),
    ("person.andrew", "Home", False, "case-sensitive"),
    ("person.teija", "home", False, "does not exist"),
    ("Person.Andrew", "home", False, "Invalid entity ID format"),
