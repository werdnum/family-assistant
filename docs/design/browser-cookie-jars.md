...
> **Update (2026-07-17)**: the browser-server mechanism (milestones 1–4) has shipped. See
> [browser-saved-sessions-fa-scoping.md](browser-saved-sessions-fa-scoping.md) for the
> reconciliation of this design against the shipped API and the concrete FA-side work breakdown.
