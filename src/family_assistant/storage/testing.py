...
async def test_engine() -> AsyncGenerator[AsyncEngine, None]:
    ...
    async with engine.begin() as conn:
        ...
        await conn.execute(AsyncConnection.sync_connection_callable(
...
@pytest.fixture
async def test_db_context(test_engine: AsyncEngine) -> AsyncGenerator[DatabaseContext, None]:
    """
...
async def run_with_test_db(
    test_func: Callable[[DatabaseContext, Any], T], 
    *args: Any, 
    **kwargs: Any
) -> T:
    """
