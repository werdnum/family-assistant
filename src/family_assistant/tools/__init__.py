...
AVAILABLE_FUNCTIONS: dict[str, Callable] = {
    ...
    "list_pending_actions": list_pending_actions_tool,
    "modify_pending_action": modify_pending_action_tool,
    "cancel_pending_action": cancel_pending_action_tool,
