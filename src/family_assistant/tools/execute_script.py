...
SCRIPT_TOOLS_DEFINITION: list[dict[str, Any]] = [
    {
        ...
        "function": {
            ...
            "description": (
                ...
                "Attachments created by tools or attachment_create() can be returned from scripts.\n"
                "The LLM will automatically receive these attachments:\n\n"
                "```starlark\n"
                "# Single attachment - last expression is returned\n"
                "chart = create_vega_chart(spec=spec_json, data_attachments=[data])\n"
                "chart  # Chart automatically visible to LLM\n\n"
                "# Multiple attachments - return list\n"
                "chart1 = create_chart(data1)\n"
                "chart2 = create_chart(data2)\n"
                "[chart1, chart2]  # Both charts visible\n\n"
