...
# This is a common pattern, but ensure notes_router handles "/"
# If notes_router's root is also "/", this explicit redirect might be redundant
# or could be to a different default page if desired.
@app.get("/")
async def root_redirect(request: Request) -> RedirectResponse:
    # Assuming notes_router is mounted at "/" and has a GET endpoint for it.
    # If notes_router is prefixed, adjust the URL.
    ...
    pass  # FastAPI will route to notes_router.get("/")
