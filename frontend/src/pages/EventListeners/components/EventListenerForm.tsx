...
interface EventListenerFormProps {
  isEdit: boolean;
...
const EventListenerForm: React.FC<EventListenerFormProps> = ({ isEdit, onSuccess, onCancel }) => {
  ...
  const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      if (isEdit) {
        ...
        url = new URL('/api/event-listeners', window.location.origin);
      }
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              {!isEdit ? (
                <Select
                  ...
                  onValueChange={(value) =>
                    handleSelectChange('action_type', value as 'wake_llm' | 'script')
                  }
                >
                  <SelectTrigger>
                    <SelectValue />
            ...
            <div className="space-y-4">
              ...
              <RadioGroup
                ...
                onValueChange={(value) =>
                  handleSelectChange('condition_type', value as 'json' | 'script')
                }
                className="space-y-3"
              >
