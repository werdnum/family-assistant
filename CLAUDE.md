...
The project uses `mdformat` to ensure consistent formatting of Markdown files. It's configured with
GitHub Flavored Markdown (GFM) support and additional plugins for tables and frontmatter.
...
Configuration is stored in `.mdformat.toml` with the following settings:

- Line wrap at 100 characters
- Consecutive numbering for ordered lists
- GitHub Flavored Markdown extensions
- Support for tables and frontmatter

**Pre-commit Integration**: `mdformat` runs automatically via pre-commit hooks. It will format your
Markdown files before each commit to ensure consistency.
