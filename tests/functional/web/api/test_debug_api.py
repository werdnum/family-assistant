...
async def test_dump_profiles_runtime_info_for_retrying_llm_client(
    ...
    class _RetryingLikeClient:
        ...
        def __init__(self) -> None:
            ...
            self.fallback_model = "models/gemini-3.7-flash"
    ...
    try:
        ...
        assert runtime["llm_fallback_model"] == "gemini-3.7-flash"
...
async def test_dump_profiles_includes_operator_layer(
    ...
    profile = ServiceProfile(
        ...
        processing_config=ProcessingConfig(llm_model="gemini/gemini-3.7-flash"),
        tools_policy=ToolPolicyConfig(
            rules=[
                PolicyRule(
