...
async def test_recurring_task_respects_user_timezone(
    ...
    # ast-grep-ignore: no-asyncio-sleep-in-tests - Waiting for task to be written to database
    ...
    # ast-grep-ignore: no-asyncio-sleep-in-tests - Waiting for task worker to process callback
